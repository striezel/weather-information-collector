...
| ------------- | ----------- | ------------------------ |
| MariaDB 12.3  | yes         | yes                      |
| MariaDB 12.2  | yes         | yes                      |
| MariaDB 12.1  | yes         | no (reached end of life) |
| MariaDB 12.0  | yes         | no (reached end of life) |
| MariaDB 11.8  | yes         | yes                      |
| MariaDB 11.7  | yes         | no (reached end of life) |
| MariaDB 11.6  | yes         | no (reached end of life) |
...
| MySQL 9.7     | yes _(*)_   | yes                      |
| MySQL 9.6     | yes _(*)_   | no (reached end of life) |
| MySQL 9.5     | yes _(*)_   | no (reached end of life) |
| MySQL 9.4     | yes _(*)_   | no (reached end of life) |
| MySQL 9.3     | yes _(*)_   | no (reached end of life) |
| MySQL 9.2     | yes _(*)_   | no (reached end of life) |
