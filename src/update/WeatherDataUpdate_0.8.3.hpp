...
#ifndef WEATHER_INFORMATION_COLLECTOR_WEATHERDATAUPDATE_0_8_3_HPP
#define WEATHER_INFORMATION_COLLECTOR_WEATHERDATAUPDATE_0_8_3_HPP
...
/** \brief Function object to update weather data for version 0.8.3.
 */
class WeatherDataUpdate_083
{
  public:
     ...
     */
    WeatherDataUpdate_083(const ConnectionInformation& _ci);
     ...
     */
    void operator()(const unsigned int startIdx, const unsigned int endIdx, const std::map<int, ApiType>& id_to_type, const mysqlpp::StoreQueryResult& result);
...
#endif // WEATHER_INFORMATION_COLLECTOR_WEATHERDATAUPDATE_0_8_3_HPP
