...
#ifndef WEATHER_INFORMATION_COLLECTOR_NLOHMANNJSONAPIXU_HPP
#define WEATHER_INFORMATION_COLLECTOR_NLOHMANNJSONAPIXU_HPP
...
/** \brief Handles JSON input from the Apixu API with the JSON library by NLohmann.
 */
class NLohmannJsonApixu
{
  public:
...
#endif // WEATHER_INFORMATION_COLLECTOR_NLOHMANNJSONAPIXU_HPP
