...
TEST_CASE("Class NLohmannJsonOpenMeteo")
{
  ...
  SECTION("parseLocations")
  {
    ...
    {
      const std::string json = "{ \"this\": 'is not valid, JSON: true";
      REQUIRE_FALSE( NLohmannJsonOpenMeteo::parseLocations(json, locations) );
    }

    SECTION("empty string")
    {
      REQUIRE_FALSE( NLohmannJsonOpenMeteo::parseLocations("", locations) );
    }
    ...
    {
      REQUIRE_FALSE( NLohmannJsonOpenMeteo::parseLocations("    ", locations) );
      REQUIRE_FALSE( NLohmannJsonOpenMeteo::parseLocations("\n", locations) );
      REQUIRE_FALSE( NLohmannJsonOpenMeteo::parseLocations("\r", locations) );
      REQUIRE_FALSE( NLohmannJsonOpenMeteo::parseLocations("\r\n\r\n", locations) );
      REQUIRE_FALSE( NLohmannJsonOpenMeteo::parseLocations("\t\t\t\t", locations) );
    }
    ...
    SECTION("successful parsing with zero elements")
    {
      ...
      REQUIRE( NLohmannJsonOpenMeteo::parseLocations(json, locations) );
