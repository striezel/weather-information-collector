...
#ifndef WEATHER_INFORMATION_COLLECTOR_NLOHMANNJSONDARKSKY_HPP
#define WEATHER_INFORMATION_COLLECTOR_NLOHMANNJSONDARKSKY_HPP
...
/** \brief Handles JSON input from the DarkSky API with the JSON library by NLohmann.
 */
class NLohmannJsonDarkSky
{
  public:
    // alias for type that keeps JSON values / objects / arrays, etc.
    typedef nlohmann::json value_type;
...
#endif // WEATHER_INFORMATION_COLLECTOR_NLOHMANNJSONDARKSKY_HPP
