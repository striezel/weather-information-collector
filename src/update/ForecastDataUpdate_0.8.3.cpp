...
void ForecastDataUpdate_083::operator()(const std::size_t startIdx, const std::size_t endIdx, const std::map<int, ApiType>& id_to_type, const db::mariadb::Result& result)
{
  m_failed = false;
  try
  {
