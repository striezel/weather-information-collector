...
#ifndef WEATHER_INFORMATION_COLLECTOR_WEATHERSTACK_HPP
#define WEATHER_INFORMATION_COLLECTOR_WEATHERSTACK_HPP
...
/** \brief Handles API requests for Weatherstack.com.
 */
class Weatherstack: public API
{
  public:
    /** \brief Constructor.
     *
     ...
     *
     * \return Returns true, because Weatherstack requests need a key.
     */
...
#endif // WEATHER_INFORMATION_COLLECTOR_WEATHERSTACK_HPP
