...
TEST_CASE("NLohmannJsonOwm")
{
  ...
  SECTION("parseLocations")
  {
    ...
    {
      const std::string json = "{ \"this\": 'is not valid, JSON: true";
      REQUIRE_FALSE( NLohmannJsonOwm::parseLocations(json, locations) );
    }

    SECTION("empty string")
    {
      REQUIRE_FALSE( NLohmannJsonOwm::parseLocations("", locations) );
    }
    ...
    {
      REQUIRE_FALSE( NLohmannJsonOwm::parseLocations("    ", locations) );
      REQUIRE_FALSE( NLohmannJsonOwm::parseLocations("\n", locations) );
      REQUIRE_FALSE( NLohmannJsonOwm::parseLocations("\r", locations) );
      REQUIRE_FALSE( NLohmannJsonOwm::parseLocations("\r\n\r\n", locations) );
      REQUIRE_FALSE( NLohmannJsonOwm::parseLocations("\t\t\t\t", locations) );
    }
    ...
    SECTION("successful parsing with zero elements")
    {
      ...
      REQUIRE( NLohmannJsonOwm::parseLocations(json, locations) );
