...
#ifndef WEATHER_INFORMATION_COLLECTOR_JSONCPPAPIXU_HPP
#define WEATHER_INFORMATION_COLLECTOR_JSONCPPAPIXU_HPP
...
/** \brief Handles JSON input from the Apixu API with the JsonCpp library.
 */
class JsonCppApixu
{
  public:
...
#endif // WEATHER_INFORMATION_COLLECTOR_JSONCPPAPIXU_HPP
