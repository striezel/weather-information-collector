...
CMake 2.8 or later, the cURL library (>=7.17), the JsonCpp library and Boost's
filesystem library. pkg-config is required to make it easier to find compiler
...
All of that can usually be installed be typing
    ...
    apt-get install catch cmake g++ git libboost-filesystem-dev libcurl4-gnutls-dev libjsoncpp-dev pkg-config

or

    yum install catch cmake gcc-c++ git boost-filesystem boost-devel libcurl-devel jsoncpp-devel pkgconfig
